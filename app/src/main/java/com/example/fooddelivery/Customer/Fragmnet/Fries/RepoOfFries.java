...
public class RepoOfFries {


    public Single<List<Food>> getFries() {
        ...
        return Single.create(new SingleOnSubscribe<List<Food>>() {
            ...
            public void subscribe(@NonNull SingleEmitter<List<Food>> emitter) throws Throwable {
                fooodDatabase.orderByChild("category").equalTo("Fries").addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
