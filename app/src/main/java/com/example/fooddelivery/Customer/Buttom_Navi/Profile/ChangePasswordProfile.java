...
public class ChangePasswordProfile extends AppCompatActivity {
    ...
    public void findview() {
        oldpassword = findViewById(R.id.pass_new);
        newpassword = findViewById(R.id.passconf_new);
        forgetPassword = findViewById(R.id.forget_profilepassword);
    ...
    user.updatePassword(getnewPassword).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(ChangePasswordProfile.this, "Password Successfully changed", Toast.LENGTH_SHORT).show();
                } else {
                    Log.d("TAG", task.getException().getMessage().toString());
                    Toast.makeText(ChangePasswordProfile.this, "Error : " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
        });
